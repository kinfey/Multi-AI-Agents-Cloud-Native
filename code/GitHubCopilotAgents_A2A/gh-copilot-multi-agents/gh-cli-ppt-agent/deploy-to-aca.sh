#!/bin/bash
# Deploy gh-cli-ppt-agent to Azure Container Apps
# This script will:
...
echo "=========================================="
echo "Deploying gh-cli-ppt-agent to Azure Container Apps"
echo "=========================================="
...
az containerapp create \
  ...
  --env-vars "COPILOT_GITHUB_TOKEN=secretref:copilot-github-token" "AGENT_PORT=8002" \
  -o table
