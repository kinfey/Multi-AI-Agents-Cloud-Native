"""Regenerate ``evals/evals.json`` from the in-repo default test cases.

Run from the repo root with the ``agentdev`` conda env activated::

    conda activate agentdev
    python -m azure_skill_eval.evals.export_evals
"""
...
from shared.test_cases import DEFAULT_CASES
